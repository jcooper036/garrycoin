...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " garrycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  garrycoin-tx [options] <hex-tx> [commands]  Update hex-encoded garrycoin transaction\n" +
            "or:     garrycoin-tx [options] -create [commands]   Create hex-encoded garrycoin transaction\n" +
            "\n";
