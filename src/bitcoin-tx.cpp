...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s garrycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  garrycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded garrycoin transaction") + "\n" +
              "  garrycoin-tx [options] -create [commands]   " + _("Create hex-encoded garrycoin transaction") + "\n" +
              "\n";
