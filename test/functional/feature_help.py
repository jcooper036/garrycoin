...
"""Verify that starting garrycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start garrycoin with -h for help text")
        ...
        self.log.info("Start garrycoin with -version for version information")
        ...
        self.log.info("Start garrycoind with -fakearg to make sure it does not start")
