# Support for Output Descriptors in Garrycoin Core

Since Garrycoin Core v0.17, there is support for Output Descriptors. This is a
...
on Garrycoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Garrycoin Core wallets, a convenience function `combo` is
